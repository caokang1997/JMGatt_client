...
Page({
  ...
  onLoad: function(e) {
    var t = this;
    this.data.jmZtmxm = e.jmZtmxm, console.log("--- 设置页面 ---"), console.log(e), this.bleConnectPopUp = this.selectComponent("#dialog"), this.changeNamePopUp = this.selectComponent("#dialog"), this.Toilet = n.getXiaoMuToiletController(), this.getDeviceName(), this.onMsgValueChange(null), this.Toilet.setMsgValueChangeCallBack((function(e) {
      t.onMsgValueChange(e)
    })), console.log("设置页面 --- 注册事件"), o.on("event", this.customEventHandler)
  },
  onReady: function() {},
  onShow: function() {
    console.log("------- 智能马桶设置页面onShow -------")
  },
  customEventHandler: function(e) {
    console.log("设置页面 --- 收到事件", e), null != e.connect && 0 == e.connect && (console.log("收到蓝牙断开事件", e), wx.navigateBack()), null != e.appOnHide && e.appOnHide && wx.navigateBack()
  },
  onHide: function() {
    console.log("------- 智能马桶主页onHide -------")
  },
  onUnload: function() {
  ...
  doSwitchAutoBubble: function(e) {
    console.log("------ doSwitchAutoBubble ------"), console.log(e.detail.check.data);
    var t = e.detail.check.data;
    this.Toilet.setAutoBubble(t)
  },
  doSwitchAutoFlush: function(e) {
    console.log(e.detail.check.data);
    var t = e.detail.check.data;

...
var i = require("miniprogram-computed").behavior,
  n = require("../../../../utils/bluetooth/bleutil.js"),
...
Page({
  ...
  sendCommandWithTime: function(e, t) {
    ...
    this.data.uiLockTimer = setTimeout((function() {
      i.data.onUiLock = !1, n.onMsgValueChange(null), i.setData({
        customItem: null
      })
    }), t)
  },
  ...
  onClickSetting: function(e) {
    this.data.currentPageIsOnTop = !1, console.log("打开设置"), wx.navigateTo({
      url: "/pages/device/xmtoilet/setting/index?jmZtmxm=" + this.data.jmZtmxm
    })
  },
  ...
  onLoad: function(t) {
    ...
    console.log(t);
    var n = t.version2;
    if (n && ("false" == n ? (this.setData({
        version2: !1
      }), console.log("------- this.data.version2 (1)-------", this.data.version2)) : "true" == n && (console.log("------- this.data.version2 (2)-------", this.data.version2), this.setData({
        version2: !0
      }))), console.log("------- options -------", t), this.initFaultList(), o.on("event", this.customEventHandler), console.log("------- 生命周期onLoad -------"), this.bleConnectPopUp = this.selectComponent("#dialog"), this.telephonePopUp = this.selectComponent("#telephone-dialog"), this.Toilet = l.getXiaoMuToiletController(), this.isDeviceConnected = !0, t.jmZtmxm) {
      this.data.jmZtmxm = t.jmZtmxm, this.Toilet.jmZtmxm = t.jmZtmxm;
      var s = e.default.getDeviceModelByJmZtmxm(t.jmZtmxm).toLowerCase();
      this.setData({
        model: s
      })
    }
    this.onMsgValueChange(null), this.Toilet.setMsgValueChangeCallBack((function(e) {
      i.onMsgValueChange(e)
  ...
  onShow: function() {
    ...
    for (var e = [], t = this.Toilet.selectedCustomModes, i = 0; i < t.length; ++i) {
      var n = t[i],
        o = this.data.customList[n];
      e.push(o)
    }
    this.setData({
      selectedList: e
  ...
  connectBleDevice: function() {
    ...
    this.bleConnectPopUp.show(), this.setData({
      connectState: 0
    }), n.checkBlePermision().then((function(t) {
